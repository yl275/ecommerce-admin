  ...
  return (
    <aside
      className={
        ...
        "top-0 text-gray-500 p-4 fixed w-full bg-gray-300 h-full md:static md:w-auto transition-all duration-300 flex flex-col"
      }
    >
      <Logo />
      ...
      <button
        onClick={logout}
        className="bg-white p-2 px-4 rounded-lg text-black text-lg mt-auto"
      >
        Logout
      </button>
    </aside>
